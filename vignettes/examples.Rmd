...
plot(layout, col=colors, pch=19, cex=2.5)
```
...
plot(layout, col=year_colors[years], pch=19, cex=2.5)
legend('bottomleft', legend=names(year_colors), col=year_colors, lty=1, lwd=3)
```
...
We can then use this to color the provided 2D UMAP projection:
